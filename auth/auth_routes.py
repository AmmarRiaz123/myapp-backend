...
def signup():
    try:
        ...
        # Pass all fields to sign_up
        result = cognito.sign_up(email, password, username, phone_number, address, name)
        if result['success']:
            return jsonify({'success': True, 'message': 'Please check your email for verification code'}), 201
